## 블로그
관련 TIL : https://hnjog.github.io/unreal/c++/PersonalServerProject/<br>

## 구현 기능
관련 영상 : https://www.youtube.com/watch?v=j35FsiR8ONQ <br>
...
사실 여러 개념들을 정리하며<br>
대략적인 개념은 이해하였다 생각하였지만<br>

실제로 구현해보니<br>
RPC 와 클라이언트 동기화(Replicate) 쪽 문제를 실감할 수 있었다<br>

- 권한에 대한 검사가 까다로워야 하는 이유<br>
- 권한에 따라 클라/서버 처리를 다르게 하여도 괜찮을 수 있다고 생각하였다<br>
